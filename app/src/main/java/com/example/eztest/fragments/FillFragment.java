...
public class FillFragment extends Fragment implements View.OnClickListener {
    ...
    ArrayList<com.example.eztest.models.question> questions;
    ...
    private com.example.eztest.models.test test;
    ...
    public static FillFragment newInstance(test test1) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootview= inflater.inflate(R.layout.fragment_fill, container, false);
        setupviews();
        return rootview;
